...
import NavigationComponent from "./TryNavigation";
...
const TryTestAppear = () => {
  ...
  const [currentval, setCurrentValue] = React.useState(null);
  var time = {};

  const sendDataToParent = (currentval) => { // the callback. Use a better name
      ...
      <div>
        <div>
          <div>
            ...
            <NavigationComponent sendDataToParent={sendDataToParent}/>
            <div>
